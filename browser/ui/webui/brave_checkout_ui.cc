...
class CheckoutMessageHandler : public content::WebUIMessageHandler {
 ...
 private:
  ...
  void GetPublisherDetailsCallback(const ledger::type::Result result,
...
void CheckoutMessageHandler::OnGetPublisherDetails(
  ...
  if (auto* service = GetRewardsService()) {
    ...
    service->GetPublisherInfo(
        ...
        base::BindOnce(&CheckoutMessageHandler::GetPublisherDetailsCallback,
...
void CheckoutMessageHandler::GetRewardsParameters(const base::ListValue* args) {
  if (auto* service = GetRewardsService()) {
    ...
    service->GetRewardsParameters(
        base::Bind(&CheckoutMessageHandler::GetRewardsParametersCallback,
                   weak_factory_.GetWeakPtr()));
  }
}
