...
void GetPublisherDetailsCallback(WebContents* initiator,
                                 base::WeakPtr<PaymentRequest> request,
...
void ShowCheckoutDialog(WebContents* initiator,
  ...
  auto* service = RewardsServiceFactory::GetForProfile(
  ...
  service->GetPublisherInfo(
      ...
      base::BindOnce(&GetPublisherDetailsCallback, initiator, request));
}
