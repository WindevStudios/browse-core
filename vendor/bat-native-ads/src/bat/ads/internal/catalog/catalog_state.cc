    ...
    for (const auto& creative_set : campaign["creativeSets"].GetArray()) {
      ...
      for (const auto& creative : creative_set["creatives"].GetArray()) {
        ...
        if (code == "notification_all_v1") {
          ...
          creative_info.payload.body =
              "Etiam porta sem malesuada magna mollis euismod. Donec sed odio "
              "dui. Aenean lacinia bibendum nulla sed consectetur. Nullam quis "
              "risus eget urna mollis ornare vel eu leo. Maecenas sed diam "
              "eget risus varius blandit sit amet non magna. Cras justo odio, "
              "dapibus ac facilisis in, egestas eget quam. Cras mattis "
              "consectetur purus sit amet fermentum.";
          creative_info.payload.title =
              "Etiam porta sem malesuada magna mollis euismod. Donec sed odio "
              "dui. Aenean lacinia bibendum nulla sed consectetur. Nullam quis "
              "risus eget urna mollis ornare vel eu leo. Maecenas sed diam "
              "eget risus varius blandit sit amet non magna. Cras justo odio, "
